...
namespace Nettixcode\App\Traits;
    ...
    public static function createModal($controller, $actions, $ids, $titles, $isforms, $functionNames, ...$functionParams)
    {
        ...
        $content = '
				...
				<div class="modal-footer border-top">
					<button class="btn btn-sm btn-outline-warning btn-rounded fw-bold" type="submit" ' . ($isforms ? 'data-form="' . $actions . '-form"' : 'data-bs-dismiss="modal"') . ' id="submit" data-value="Submit">
